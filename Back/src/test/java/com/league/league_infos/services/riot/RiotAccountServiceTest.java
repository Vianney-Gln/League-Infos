...
class RiotAccountServiceTest {
    ...
    void getAccountByPuuid_succes() {
        ...
        // WHEN
        AccountDTO result = accountService.getAccountByPuuid("1234");

        // THEN
        assertThat(result).isNotNull().extracting("gameName", "tagLine", "puuid")
    ...
    void getAccountByGameName_succes() {
        ...
        // WHEN
        AccountDTO result = accountService.getAccountByRiotId("Test", "euw");
