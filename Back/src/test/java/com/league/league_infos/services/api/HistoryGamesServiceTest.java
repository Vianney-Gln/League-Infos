...
class HistoryGamesServiceTest {
    ...
    @BeforeEach
    void init() {
        ReflectionTestUtils.setField(historyGamesService, "MAX_COUNT_MATCH_HISTORY", 3);
    }
    ...
    void getHistoryIds_succes_1() {
        ...
        // WHEN
        List<String> result = historyGamesService.getHistoryIds("puuid", 420);
    ...
    void getHistoryIds_success_2() {
        ...
        // WHEN
        List<String> result = historyGamesService.getHistoryIds("puuid", null);
    ...
    void getHistoryIds_echec_1() {
        ...
        // WHEN + THEN
        assertThatThrownBy(() -> historyGamesService.getHistoryIds("puuid", null))
    ...
    void getMatchHistory_echec_1() {
        ...
        // WHEN + THEN
        assertThatThrownBy(() -> historyGamesService.getMatchHistory("id"))
                .isInstanceOf(BusinessException.class)
                .hasMessage(ERROR_BUSINESS_1.getLibelle());
    }
    ...
    void getMatchHistory_success_1() {
        ...
        // WHEN
        MatchDTO result = historyGamesService.getMatchHistory("id");
