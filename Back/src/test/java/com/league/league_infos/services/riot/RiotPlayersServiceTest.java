...
class RiotPlayersServiceTest {
    ...
    void getLeagueChallengerDataSoloQ_succes() {
        ...
        // WHEN
        LeagueListDTO result = riotPlayersService.getLeagueChallengerDataSoloQ();

        // THEN
        assertThat(result).isNotNull()
                .extracting("leagueId", "name", "tier", "queue")
                .containsExactly("50", "nom de la ligue", "CHALLENGER", "SOLO Q 5V5");
        assertThat(result.getEntries()).isNotNull().isNotEmpty()
        ...
        assertThat(result.getEntries().getFirst().getMiniSeries()).isNull();
    }
    ...
    void getLeagueChallengerDataFlexQ_succes() {
        ...
        // WHEN
        LeagueListDTO result = riotPlayersService.getLeagueChallengerDataFlexQ();
    ...
    void getLeagueEntriesByPuuid_succes() {
        ...
        // WHEN
        List<LeagueEntryDTO> result = riotPlayersService.getLeagueEntriesByPuuid("puuidxxxxx");

        // THEN
        assertThat(result).isNotNull().isNotEmpty().hasSize(2);

        assertThat(result).extracting("leagueId", "summonerId", "puuid", "rank", "tier", "queueType",
    ...
    void getLeagueEntriesByPuuid_echec_1() {
        ...
        // WHEN + THEN
        assertThatThrownBy(() -> riotPlayersService.getLeagueEntriesByPuuid("puuidxxxxx"))
    ...
    void getChampionMasteriesByPuuid_succes() {
        ...
        // WHEN
        List<ChampionMasteryDTO> result = riotPlayersService.getChampionMasteriesByPuuid("puuid");

        // THEN
        assertThat(result).isNotNull().isNotEmpty().hasSize(1);
        assertThat(result).extracting("puuid",
                "championId",
                "lastPlayTime",
    ...
    void getChampionMasteriesByPuuid_echec_1() {
        ...
        // WHEN + THEN
        assertThatThrownBy(() -> riotPlayersService.getChampionMasteriesByPuuid("puuidxxxxx"))
                .isInstanceOf(BusinessException.class)
                .hasMessage(ERROR_BUSINESS_1.getLibelle());
    }
