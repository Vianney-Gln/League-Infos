...
class RiotSummonersServiceTest {
    ...
    void getSummonerByPuuid_succes() {
        ...
        // WHEN
        SummonerDTO result = riotSummonersService.getSummonerByPuuid("1234");

        // THEN
        assertThat(result).isNotNull().extracting("summonerLevel", "profileIconId", "accountId", "revisionDate", "id", "puuid")
